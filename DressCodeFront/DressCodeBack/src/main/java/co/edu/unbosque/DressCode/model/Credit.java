...
public class Credit {
	...
	public Credit(Integer id_amortization, Integer id_sale, String customer_document, int current_quota, float balance,
			float quota_value, float interest, float amortization) {
		super();
